...
function get_similar(id,address,name) {
  ...
  .done(function(json) {
    document.getElementById("similar1-name").innerHTML=json[0].name.split('[')[0].split('(')[0];
    ...
    // 두번째 유사숙소
    document.getElementById("similar2-name").innerHTML=json[1].name.split('[')[0].split('(')[0];
